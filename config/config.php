...
# Ideally, this should match the domain name
	define('APP_EMAIL', 'message@kittykorner.biz'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'system@kittykorner.biz'); 

# Default DB name for this app
	define('DB_NAME', 'p2_kittykorner_biz'); 
...
# For extra security, you might want to set different salts than what the core uses
	//define('PASSWORD_SALT', 'sliaeosldir');
	//define('TOKEN_SALT', 'liselifalil');